"""
Contains classes used to configure a TalonFX.
...
class TalonFXConfigurator(ParentConfigurator):
    ...
    def apply(self, configs: TalonFXConfiguration, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        :returns: Status code of applying the configs
        :rtype: StatusCode
        """
        ...
    ...
    def refresh(self, configs: TalonFXConfiguration, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        :param timeout_seconds: Maximum amount of time to wait when performing configuration
        :type timeout_seconds: second
        :returns: Status code of refreshing the configs
        :rtype: StatusCode
        """
        ...
    ...
    def clear_sticky_fault_rotor_fault1(self, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(SpnValue.CLEAR_STICKY_FAULT_TALONFX_ROTOR_FAULT1.value, 0, ctypes.byref(value))
        if value.value is not None:
            serialized = str(value.value, encoding='utf-8')
            Native.instance().c_ctre_phoenix6_free_memory(ctypes.byref(value))
        else:
    ...
    def clear_sticky_fault_rotor_fault2(self, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(SpnValue.CLEAR_STICKY_FAULT_TALONFX_ROTOR_FAULT2.value, 0, ctypes.byref(value))
        if value.value is not None:
            serialized = str(value.value, encoding='utf-8')
            Native.instance().c_ctre_phoenix6_free_memory(ctypes.byref(value))
        else:
