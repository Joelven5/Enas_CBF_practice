"""
Contains the status codes reported by APIs.
...
class StatusCode(Enum):
    ...
    """
    Unable to set ID to this device. Confirm that this action is valid for this
    device and the ID is valid (0-62).
    """
    ...
    """
    INVALID_DEVICE_ID = -10044
    """
    The device ID is invalid. Ensure the device is constructed with a valid ID
    (0-62).
    """
    ...
    def description(self) -> str:
        ...
        if False:
            ...
            return "Unable to set ID to this device. Confirm that this action is valid for this device and the ID is valid (0-62)."
        elif self.value == -110:
            ...
            return "The device ID is invalid. Ensure the device is constructed with a valid ID (0-62)."
        else:
            return f"Status Code {self.value}"
