"""
Contains the class for controlling a device using SolidColor.
...
class SolidColor:
    ...
    def _send_request(self, network: CANBus, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlSolidColor(ctypes.c_char_p(bytes(network.name, 'utf-8')), device_hash, 0, self.led_start_index, self.led_end_index, self.color.red, self.color.green, self.color.blue, self.color.white))
