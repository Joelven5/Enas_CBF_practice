"""
Contains the class for controlling a device using Diff_VelocityVoltage_Position.
...
class Diff_VelocityVoltage_Position:
    ...
    def _send_request(self, network: CANBus, device_hash: int) -> StatusCode:
        """
