"""
Contains the class representing a unique identifier for a device.
...
class DeviceIdentifier:
    ...
    def __init__(self, device_id: int, model: str, canbus: CANBus):
        ...
        if self.__device_hash == 0 and self.__device_id != -1:
            raise ValueError(StatusCode.INVALID_DEVICE_ID.description)
