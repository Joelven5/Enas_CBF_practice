"""
Contains the class for CTR Electronics' CANdi™ branded device, a device that
integrates digital signals into the existing CAN bus network.
...
class CoreCANdi(ParentDevice):
    ...
    def none(cls):
        """
        Constructs a stubbed-out CoreCANdi, where all status signals, controls, configs,
