"""
Contains the class description for the Talon FX integrated motor controller.
...
class CoreTalonFX(ParentDevice, CommonTalonWithFOC):
    ...
    def none(cls):
        ...
        etc. perform no action and immediately return OK. This can be used to silence
        error messages for devices that have been completely removed from the robot.

        :returns: Stubbed-out CoreTalonFX
        :rtype: CoreTalonFX
        """
        return cls(-1, CANBus())
    ...
    @final
    def get_fault_rotor_fault1(self, refresh: bool = True) -> StatusSignal[bool]:
        """
        Trips if a major mechanical or ESD event caused a brief loss of
        position data triggering a recovery while not in motion. If the event
        occurs often, inspect for excess axial force or sources of ESD at the
        rotor.
        ...
        :param refresh: Whether to refresh the StatusSignal before returning it;
                        defaults to true
        :type refresh: bool
        :returns: Fault_RotorFault1 Status Signal Object
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_TALONFX_ROTOR_FAULT1.value, "fault_rotor_fault1", None, bool, True, refresh)
    
    @final
    def get_sticky_fault_rotor_fault1(self, refresh: bool = True) -> StatusSignal[bool]:
        """
        Trips if a major mechanical or ESD event caused a brief loss of
        position data triggering a recovery while not in motion. If the event
        occurs often, inspect for excess axial force or sources of ESD at the
        ...
        :param refresh: Whether to refresh the StatusSignal before returning it;
                        defaults to true
        :type refresh: bool
        :returns: StickyFault_RotorFault1 Status Signal Object
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_TALONFX_ROTOR_FAULT1.value, "sticky_fault_rotor_fault1", None, bool, True, refresh)
    
    @final
    def get_fault_rotor_fault2(self, refresh: bool = True) -> StatusSignal[bool]:
        """
        Trips if a major mechanical or ESD event caused a brief loss of
        position data triggering a recovery while in motion. If the event
        occurs often, inspect for excess axial force or sources of ESD at the
        rotor.
        ...
        :param refresh: Whether to refresh the StatusSignal before returning it;
                        defaults to true
        :type refresh: bool
        :returns: Fault_RotorFault2 Status Signal Object
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_TALONFX_ROTOR_FAULT2.value, "fault_rotor_fault2", None, bool, True, refresh)
    
    @final
    def get_sticky_fault_rotor_fault2(self, refresh: bool = True) -> StatusSignal[bool]:
        """
        Trips if a major mechanical or ESD event caused a brief loss of
        position data triggering a recovery while in motion. If the event
        occurs often, inspect for excess axial force or sources of ESD at the
        ...
        :param refresh: Whether to refresh the StatusSignal before returning it;
                        defaults to true
        :type refresh: bool
        :returns: StickyFault_RotorFault2 Status Signal Object
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_TALONFX_ROTOR_FAULT2.value, "sticky_fault_rotor_fault2", None, bool, True, refresh)
    ...
    @overload
    def set_control(self, request: EmptyControl) -> StatusCode:
        """
        Apply a generic empty control used to do nothing.

        :param request: Control object to request of the device
        :type request: EmptyControl
        :returns: Status code of the request
        :rtype: StatusCode
        """
        ...
    ...
    @final
    def clear_sticky_fault_rotor_fault1(self, timeout_seconds: second = 0.100) -> StatusCode:
        """
        Clear sticky fault: Trips if a major mechanical or ESD event caused a
        brief loss of position data triggering a recovery while not in motion.
        If the event occurs often, inspect for excess axial force or sources
        of ESD at the rotor.
        ...
        return self.configurator.clear_sticky_fault_rotor_fault1(timeout_seconds)
    
    @final
    def clear_sticky_fault_rotor_fault2(self, timeout_seconds: second = 0.100) -> StatusCode:
        """
        Clear sticky fault: Trips if a major mechanical or ESD event caused a
        brief loss of position data triggering a recovery while in motion. If
        the event occurs often, inspect for excess axial force or sources of
        ESD at the rotor.
        ...
        return self.configurator.clear_sticky_fault_rotor_fault2(timeout_seconds)
