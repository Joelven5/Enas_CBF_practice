"""
Contains the class for CANcoder, a CAN based magnetic encoder that provides
absolute and relative position along with filtered velocity.
...
class CoreCANcoder(ParentDevice):
    ...
    def none(cls):
        ...
        :returns: Stubbed-out CoreCANcoder
        :rtype: CoreCANcoder
        """
        return cls(-1, CANBus())
    ...
    def get_absolute_position(self, refresh: bool = True) -> StatusSignal[rotation]:
        ...
        AbsoluteSensorDiscontinuityPoint. This position is affected by the
        MagnetSensor configs and the user-set position via setPosition().
