"""
Contains the class description for the Talon FXS motor controller.
...
class CoreTalonFXS(ParentDevice, CommonTalonWithExternalMotor):
    ...
    def none(cls):
        ...
        :returns: Stubbed-out CoreTalonFXS
        :rtype: CoreTalonFXS
        """
        return cls(-1, CANBus())
