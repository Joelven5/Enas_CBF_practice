"""
Contains the class for the Talon FX integrated motor controller.
...
try:
    ...
    class TalonFX(CoreTalonFX, Sendable):
        ...
        def none(cls):
            """
            Constructs a stubbed-out TalonFX, where all status signals, controls, configs,
