"""
Contains the parent class for all devices.
...
class ParentDevice(CommonDevice):
    ...
    def __init__(self, device_id: int, model: str, canbus: CANBus):
        ...
        class FirmwareVersChecker:
            def __init__(self, device_identifier: DeviceIdentifier):
                ...
                self._compliancy: StatusSignal[int] = StatusSignal(
                    None, self._device_identifier,
                    SpnValue.COMPLIANCY_VERSION.value, "Compliancy",
                    lambda: None, None, int
                )
                ...
                if self._device_identifier.device_hash == 0:
                    self._version_status = StatusCode.OK
                else:
    ...
    def is_connected(self, max_latency_seconds: second = 0.5) -> bool:
        ...
        :rtype: bool
        """
        return self.__vers_checker._compliancy.refresh(False).timestamp.get_latency() <= max_latency_seconds
    ...
    def _set_control_private(self, request: SupportsSendRequest) -> StatusCode:
        ...
        with self.__control_request_lck:
            ...
            if (
                not self.__vers_checker._version_status.is_ok()
