"""
Contains the class for CANrange, a CAN based Time of Flight (ToF) sensor that
measures the distance to the front of the device.
...
try:
    ...
    class CANrange(CoreCANrange, Sendable):
        ...
        def none(cls):
            """
            Constructs a stubbed-out CANrange, where all status signals, controls, configs,
        ...
        def initSendable(self, builder: SendableBuilder):
            ...
            builder.addDoubleProperty("Distance", self.__distance_getter.as_supplier(), lambda _: None)
            builder.addBooleanProperty("Is Detected", self.__is_detected_getter.as_supplier(), lambda _: None)
