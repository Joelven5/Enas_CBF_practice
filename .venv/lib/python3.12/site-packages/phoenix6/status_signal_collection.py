"""
Contains the class that manages bulk refreshing device status signals.
...
class StatusSignalCollection:
    ...
    @final
    def wait_for_all(self, timeout_seconds: second, report_error: bool = True) -> StatusCode:
        """
        ...
        :param report_error: Whether to report any errors to the Driver Station/stderr
        ...
        :rtype: StatusCode
        """
        return BaseStatusSignal.wait_for_all(timeout_seconds, self._signals, report_error=report_error)

    @final
    def refresh_all(self, report_error: bool = True) -> StatusCode:
        """
        ...
        :rtype: StatusCode
        """
        return BaseStatusSignal.refresh_all(self._signals, report_error=report_error)
