"""
Module for communicating with the Phoenix 6 native libraries.
...
class Native:
    ...
    def instance(cls) -> c.CDLL:
        ...
        if cls.__instance is None:
            ...
            # If we have an explicit target, use it; otherwise, default to hardware or sim and fall back to the other
            ...
            elif find_spec("wpilib") is not None:
                targets_to_attempt = [sim_libs, hardware_libs]
            else:
                targets_to_attempt = [hardware_libs, sim_libs]
