"""
Contains the constants for individual swerve modules.
...
class SwerveModuleConstants(Generic[DriveMotorConfigsT, SteerMotorConfigsT, EncoderConfigsT]):
    ...
    def __init__(self):
        ...
        """
        When using open-loop drive control, this specifies the measured speed at which
        the robot travels when driven with 12 volts. This is used to approximate the
        output for a desired velocity; it cannot be used to change the desired max speed
        of the robot. If using closed loop control, this value is ignored.
        """
        ...
        """
        self.drive_inertia: kilogram_square_meter = 0.035
        """
